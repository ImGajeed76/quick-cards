...
export async function buildAnkiPackage(opts: AnkiExportOptions): Promise<Uint8Array> {
  ...
  //    DeckConfig. Without (config: null), ankipack ships no deck_config row
  //    and points the deck's config_id at Anki's built-in default preset
  //    (id=1), so nothing new appears in the user's preset list.
